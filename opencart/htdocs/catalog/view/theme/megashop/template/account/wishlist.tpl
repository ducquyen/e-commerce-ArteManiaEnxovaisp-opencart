  ...
  <tbody id="wishlist-row<?php echo $product['product_id']; ?>">
    <tr>
      ...
      <td class="text-right"><?php if ($product['price']) { ?>
        ...
        <?php } ?></td>
      <td class="text-right"><button type="button" onclick="cart.add('<?php echo $product['product_id']; ?>');" data-toggle="tooltip" title="Adicionar a lista de desejos" class="btn btn-primary"><i class="fa fa-shopping-cart"></i></button>
