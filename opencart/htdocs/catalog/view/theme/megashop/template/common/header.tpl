								...
								<div class="row">
									...
									<div class="col-sm-6" >
										...
										<ul class="header-links">
											<li class="heart"><a href="<?php echo $wishlist; ?>" id="wishlist-total"><?php echo $text_wishlist; ?></a></li>
											<li class="myacc"><a href="<?php echo $account; ?>"><?php echo $text_account; ?></a></li>
											<li class="shopcart"><a href="<?php echo $shopping_cart; ?>"><?php echo $text_shopping_cart; ?></a></li>
											<li class="check_ic last"><a href="<?php echo $checkout; ?>"><?php echo $text_checkout; ?></a></li>
										</ul>
									</div>
									...
									<!-- Top Bar Right-->
									<div class="col-sm-6 hidden-xs" id="top-bar-right">
                                    <?php echo $currency.$language; ?>
										<!-- Welcome text -->
										<div class="welcome-text">
											<?php if($theme_options->get( 'welcome_text', $config->get( 'config_language_id' ) ) != '') { echo html_entity_decode($theme_options->get( 'welcome_text', $config->get( 'config_language_id' ) )); } else { echo 'Telefone: (27)3724-1761'; } ?>
										</div>
									</div>
							...
							<div class="container">
								<div class="row">
                                    ...
                                    <div class="search_form">
											...
											<input type="text" class="input-block-level search-query" name="search" placeholder="PROCURE..." id="search_query" value="" />
