			    ...
			    <div class="col-sm-<?php echo $product_center_grid; ?> product-center clearfix">
			     ...
			     <div id="product">
			      ...
			      <div class="cart">
			        ...
			        <div class="links">
			        	<a class="wish" onclick="wishlist.add('<?php echo $product_id; ?>');"><?php echo $button_wishlist; ?></a>
			        	<a class="comp" onclick="compare.add('<?php echo $product_id; ?>');"><?php echo $button_compare; ?></a>
			        </div>
...
<!-- TESTE COLOCAR FUNÇÃO NO INICIO<?php if($theme_options->get( 'product_image_zoom' ) != 2) {
echo '<script type="text/javascript" src="catalog/view/theme/' . $config->get( 'config_template' ) . '/js/jquery.elevateZoom-3.0.3.min.js"></script>';
} ?>
-->
