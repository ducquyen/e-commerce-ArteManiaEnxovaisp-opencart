      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="text-center">
              ...
              <!-- TESTE ARTUR - CART <input type="image" src="catalog/view/theme/<?php echo $config->get( 'config_template' ); ?>/img/update.png" alt="<?php echo $button_update; ?>" title="<?php echo $button_update; ?>" />
