...
var searchStatus = $(this).parent().find("input[name='switch']").prop('checked');
		var callbackUrl = 'index.php?route=catalog/product/autocomplete&token=<?php echo $token; ?>&filter_name=';
...
$('input[name=\'filter_model\']').autocomplete({
	'source': function(request, response) {
var searchStatus = $(this).parent().find("input[name='switch']").prop('checked');
		var callbackUrl = 'index.php?route=catalog/product/autocomplete&token=<?php echo $token; ?>&filter_model=';
		callbackUrl += searchStatus ? '%' : '';
		callbackUrl += encodeURIComponent(request);
		$.ajax({
url:callbackUrl,
