...
// DIR
define('DIR_APPLICATION', '/opt/lampp/apps/opencart/htdocs/catalog/');
define('DIR_SYSTEM', '/opt/lampp/apps/opencart/htdocs/system/');
define('DIR_LANGUAGE', '/opt/lampp/apps/opencart/htdocs/catalog/language/');
define('DIR_TEMPLATE', '/opt/lampp/apps/opencart/htdocs/catalog/view/theme/');
